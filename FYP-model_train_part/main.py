...
# loss,accuracy = new_model.evaluate(test_batch)
print(f'loss: {loss} and accuracy: {accuracy*100}')

# export_dir = 'saved/model/3'
# tf.saved_model.save(model, export_dir)
# converter = tf.lite.TFLiteConverter.from_saved_model(export_dir)
# tflites_model = converter.convert()

# tflite_model_file = pathlib.Path("C:/Users/rosha/PycharmProjects/FYP/saved/model/3/optimized3_graph.tflite")
# tflite_model_file.write_bytes(tflites_model)
